    ...
    <div>
      ...
      <div className={styles.main}>
        <div>
          ...
          <div className={styles.description}>
            AN NFT collection for Devs in the Crypto Space
          </div>
          <div className={styles.description}>
...
//              </h1>
//              <div className={styles.description}> {numOfWhitelisted} have already joined the Whitelist
...
//   const getProviderOrSigner = async (needSigner = false) => {
//     try {
//       const provider = await web3ModalRef.current(provider);
